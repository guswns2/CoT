...
ChartJs.register(
 ...
 const DoughnutChart = () =>{
  ...
  let co2Int = localStorage.getItem('co2') !== "null" ? localStorage.getItem('co2') : 0;
    ...
    plugins: {
      ...
      datalabels: {
        ...
        formatter:(context, args) => {
          let label = "0%"
          if(context > 0) {
            label = (parseFloat((context/totalEmission)*100)+"").slice(0,4)+"%"
          }
          return label;
        },
      },
  ...
  let textCenter = {
    ...
    beforeDatasetsDraw(chart, args, pluginOptions) {
      console.log('textCenter chart: ', chart.getDatasetMeta(0))
      ...
      ctx.textAlign = "center";
      ctx.textBaseline = "middle";
      ctx.fillText(co2Int, xCoor, yCoor + 40)
